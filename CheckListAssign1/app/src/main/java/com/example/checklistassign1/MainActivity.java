...
public class MainActivity extends AppCompatActivity {
    ...
    private void calculateBMI() {
        ...
        if (!weightStr.isEmpty() && !heightStr.isEmpty()) {
            ...
            saveData(date, weight, bmi, status);
        } else {
            warnText.setText(getString(R.string.warn));
        }
    }

    private void saveData(String date, double weight, double bmiValue, String bmiStatus) {
        DecimalFormat df = new DecimalFormat("#.##");
        ...
        try {
            ...
            data.put("bmiValue", df.format(bmiValue));
            data.put("bmiStatus", bmiStatus);
